...
app.get('/wish_list_data_iwish/:project_id/:index/:num', routes.r_wish_list_data_iwish);
app.get('/wish_list_data_ongoing/:project_id', routes.r_wish_list_data_ongoing);
